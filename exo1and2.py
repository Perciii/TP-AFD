...
# tests my_lda with various lambdas and returns an array of good classification rate and an array of lambdas
...
def main():
    ...
    classifier_bis = LinearDiscriminantAnalysis()
    ...
    plt.figure("App data with outlier")
    plt.title("Test data with outlier")
    plt.plot(easy_points_x2, easy_points_y2, 'g-')
    plt.figure("Test data with outlier")
    plt.title("Test data with outlier")
    plt.plot(easy_points_x2, easy_points_y2, 'g-')
    ...
    plt.figure("Rate of good classification against variance")
    plt.title("Rate of good classification against variance")
